...
def create_material():
    ...
    # 画像をロード
    tex_image.image = bpy.data.images.load("D:\\Cluster\\ControlBox\\maze_floor_v2\\maze_combined2.png")
...
def set_obj_faceuv(obj_uv_layer,xpos1,ypos1):
    xpos2 = xpos1 + 2
    ypos2 = ypos1 + 2
    obj_uv_layer[0].uv.x = (xpos2 + 1) * (21/256)
    obj_uv_layer[1].uv.x = (xpos1 + 0) * (21/256)
    obj_uv_layer[2].uv.x = (xpos1 + 0) * (21/256)
    obj_uv_layer[3].uv.x = (xpos2 + 1) * (21/256)
